...
urlpatterns = [
    ...
    path('creditors/', CreditorChecksAPIView.as_view(), name="user creditor checks"),
    path('debtors/', DebtorChecksAPIView.as_view(), name="user debtor checks"),
    ...
    path('user/', UserViewAPI.as_view(), name="user token check"),
    path('admin/login/', AdminLoginAPIView.as_view(), name="admin login"),
    path('admin/users/', AllUserAPIView.as_view(), name="all users"),
    path('admin/travels/', AllUserTravelsAPIView.as_view(), name="all travels"),
